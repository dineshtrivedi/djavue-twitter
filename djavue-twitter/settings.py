"""
Django settings for djavue-twitter project.
...
ROOT_URLCONF = 'djavue-twitter.urls'
...
WSGI_APPLICATION = 'djavue-twitter.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './djavue-twitter.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {
